function carregarMenu() {
    ...
    fetch('../menuComponente/menu-componente.html')
        .then(response => {
            if (!response.ok) {
    ...
    if (btnSair) {
        btnSair.addEventListener('click', function(e) {
            ...
            e.stopPropagation(); 
                ...
                window.location.href = '../cadastroUsuario/cadastroUsuario.html?logout=true';
        });
    }
}
        ...
        if (usuarioJSON) {
            ...
            if (usuario.avatarImagemSrc) {
                ...
                if (usuario.avatarArvore === 'pau-brasil') {
                    navAvatar.src = 'pau-brasil-madura.svg';
                } else if (usuario.avatarArvore === 'castanheira') {
                    navAvatar.src = 'castanheira-madura.svg';
                } else if (usuario.avatarArvore === 'peroba-rosa') {
                    navAvatar.src = 'peroba-rosa-madura.svg';
                }
            }
